% Kalpajyoti Hazarika
% ttest for ITC 
% Cohens' d formula is used to calculate the effect size
% higher ITC within the condition than the across condition
...
% Cohens' d formula for sample size smaller than 40.
% Check the whether sample size is less than 40 
N = length(ITC_tar);
